<?php
/*
Plugin Name: Genesis Page Builder
Plugin URI: http://pootlepress.com/
Description: A page builder for Genesis.
Version: 1.0
Author: PootlePress
...
require_once('genesis-page-builder-functions.php');
...
// Genesis Page Builder does not use this
